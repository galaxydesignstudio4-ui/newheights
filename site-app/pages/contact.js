  ...
  return (
    <div style={{padding:40}}>
      <nav style={{marginBottom:32}}>
        <Link href="/">Home</Link> | <Link href="/about">About</Link> | <Link href="/programs">Programs</Link> | <Link href="/gallery">Gallery</Link> | <Link href="/admissions">Admissions</Link>
      </nav>
      <h1>Contact Us</h1>
      {submitted ? <p>Thank you for contacting us!</p> : (
        <form onSubmit={handleSubmit} style={{maxWidth:400}}>
          ...
          <textarea required placeholder="Message" value={form.message} onChange={e=>setForm(f=>({...f,message:e.target.value}))} style={{width:'100%',marginBottom:12,padding:8}}/><br/>
